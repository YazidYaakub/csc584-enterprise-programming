  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: 'auto', textAlign: 'center' }}>
      ...
      <section style={{ marginBottom: '40px' }}>
        ...
        <p>
          Edutech-Solution is an innovative platform that streamlines internship and student
          activity management, providing seamless solutions for both universities and companies.
        </p>
      </section>
      ...
      <section style={{ marginBottom: '40px' }}>
        ...
        <p>
          To bridge the gap between students and the industry by fostering an efficient and
          collaborative ecosystem that drives mutual growth and success.
        </p>

        <h2 style={{ fontWeight: 'bold' }}>Our Vision</h2>
        <p>
          A future where every student has access to a streamlined process for career development
      ...
      <div style={{ padding: '20px', maxWidth: '800px', margin: 'auto', textAlign: 'center' }}>
        ...
        <section>
          ...
          <p>
            To optimize our work, we have organized into two specialized teams based on project
            requirements: one team focuses on projects utilizing Oracle Database, while the other
            specializes in Java technologies, including the MVC framework, JSP, and Servlets.
          </p>
      ...
      <Button form="login-form">HOME</Button>
    </div>
  )
}
