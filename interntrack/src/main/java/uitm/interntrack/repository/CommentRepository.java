...
public interface CommentRepository extends JpaRepository<Comment, String> {
    ...
    @Query(value = """
        ...
        """, nativeQuery = true)
    Comment createComment(@Param("commentId") String commentId, @Param("commentContent") String commentContent, @Param("commentDate") Timestamp commentDate, @Param("commentAuthorId") String commentAuthorId, @Param("commentActivityId") String commentActivityId);
